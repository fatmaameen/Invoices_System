                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 data-section_name="{{ $product->product_name }}" data-description="{{ $product->description }}"
                                                      data-toggle="modal"
                                                     href="#modaldemo9" title="تعديل"><i class="las la-pen"></i>
                                                     </a>
                                                     <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                     data-id="{{ $product->id }}" data-section_name="{{ $product->product_name }}" data-toggle="modal"
                                                     href="#modaldemo1" title="حذف"><i class="las la-trash"></i></a>
                                                </td>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="form-floating">
                                    ...
                                    <select class="form-select" id="section_id" name="section_id" aria-label="Floating label select example">
                    ...
                    <div class="modal" id="modaldemo9">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    {{-- {{  route('products.update' ,$product->first()->id )}} --}}
                                <form action="" method="Post">
                                     @method('head')
                                    {{ csrf_field() }}

                                    <div class="form-group">
                                    <label for="exampleInputEmail1" >اسم المنتج الجديد</label>
                                    <input type="text" class="form-control" id="product_name" name="product_name">
                                </div>
                                <div class="form-floating">
                    ...
                    <div class="modal" id="modaldemo1">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                {{-- {{  route('products.destroy' ,$product->first()->id )}}  --}}
                                <form action="" method="Post">
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                                    <div class="modal-body">
